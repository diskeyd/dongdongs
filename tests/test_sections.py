...
from dongdongs.hwp.inspector import test_sections as report_sections
...
def test_report_sections_need_consecutive_numbers_and_latin_codes():
    ...
    sections = report_sections(inventory)
...
def test_graph_pages_stay_inside_their_section_and_later_pages_shift():
    ...
    hwp_sections = report_sections(inventory)
...
def test_graph_page_already_filled_is_no_op():
    ...
    result = build_candidates({"tables": []}, [_graph(11)], inventory, [], {}, {}, pdf_index, report_sections(inventory))
